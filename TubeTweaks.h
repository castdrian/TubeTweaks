...
@interface YTWatchViewController (TubeTweaks) <YTResponder>
...
@end
@interface YTPlayerViewController (TubeTweaks) <UIGestureRecognizerDelegate>
...
@end
@interface YTPlayerBarController (TubeTweaks)
...
@end
@interface YTMainAppVideoPlayerOverlayViewController (TubeTweaks)
@property (nonatomic, strong, readwrite) YTPlayerBarController *playerBarController;
@end
@interface YTInlinePlayerBarContainerView (TubeTweaks)
...
@interface YTMainAppControlsOverlayView (TubeTweaks)
...
@interface YTRightNavigationButtons (TubeTweaks)
...
// BigYTMiniPlayer
@interface YTMainAppVideoPlayerOverlayView (TubeTweaks)
